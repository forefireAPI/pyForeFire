...
##-----------------------------------------------------------------------------
## 
nb_steps = 3  #200             # The number of step the simulation will execute
...
print(ff["localBMapSizeX"],ff["localBMapSizeY"], np.shape(at))
ff.execute("save[]")
...
#fig, ax = plt.subplots(figsize=(6, 4))  # You can adjust figsize to better fit your data's aspect ratio
#im = ds['arrival_time_of_front'].plot(ax=ax, vmin=0, add_colorbar=True, cmap='viridis')
#ax.set_aspect('equal')  # This sets the equal aspect ratio
#plt.show()
#ds.close()
